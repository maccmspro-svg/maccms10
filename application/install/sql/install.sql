...
CREATE TABLE `mac_goods` (
  ...
  `goods_sub` varchar(255) NOT NULL DEFAULT '' COMMENT '副标题',
  `goods_en` varchar(255) NOT NULL DEFAULT '' COMMENT '英文名/别名',
  `goods_status` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '状态(0=锁定,1=正常)',
  `goods_letter` char(1) NOT NULL DEFAULT '' COMMENT '首字母',
  `goods_color` varchar(6) NOT NULL DEFAULT '' COMMENT '标题颜色',
  `goods_tag` varchar(100) NOT NULL DEFAULT '' COMMENT '标签',
  `goods_class` varchar(255) NOT NULL DEFAULT '' COMMENT '扩展分类',
  `goods_pic` varchar(1024) NOT NULL DEFAULT '' COMMENT '封面图',
  `goods_pic_thumb` varchar(1024) NOT NULL DEFAULT '' COMMENT '封面缩略图',
  `goods_pic_slide` varchar(1024) NOT NULL DEFAULT '' COMMENT '封面幻灯图',
  `goods_pic_screenshot` text DEFAULT NULL COMMENT '内容截图',
  `goods_blurb` varchar(255) NOT NULL DEFAULT '' COMMENT '简介',
  `goods_content` mediumtext DEFAULT NULL COMMENT '详细介绍',
  `goods_price` decimal(12,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '售价',
  `goods_points` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '所需积分',
  `goods_stock` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '库存数量',
  `goods_sales` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '已售数量',
  `goods_level` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '推荐级别',
  `goods_lock` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '锁定状态(0=未锁,1=已锁)',
  `goods_hits` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '总点击数',
  `goods_hits_day` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '日点击数',
  `goods_hits_week` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '周点击数',
  `goods_hits_month` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '月点击数',
  `goods_score` decimal(3,1) unsigned NOT NULL DEFAULT '0.0' COMMENT '平均评分',
  `goods_score_all` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '总评分',
  `goods_score_num` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '评分次数',
  `goods_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  `goods_time_add` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '添加时间',
  `goods_time_hits` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '点击时间',
  `goods_time_make` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '生成时间',
  `goods_jumpurl` varchar(150) NOT NULL DEFAULT '' COMMENT '跳转URL',
  `goods_tpl` varchar(30) NOT NULL DEFAULT '' COMMENT '独立模板',
  `goods_group_ids` varchar(255) NOT NULL DEFAULT '' COMMENT '可购买会员组ID,逗号分隔',
  `goods_kind` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '1虚拟2实体',
  `goods_download` mediumtext COMMENT '虚拟商品付款后展示内容',
  PRIMARY KEY (`goods_id`),
  KEY `type_id` (`type_id`) USING BTREE,
  KEY `type_id_1` (`type_id_1`) USING BTREE,
  KEY `goods_level` (`goods_level`) USING BTREE,
  KEY `goods_hits` (`goods_hits`) USING BTREE,
  KEY `goods_time` (`goods_time`) USING BTREE,
  KEY `goods_letter` (`goods_letter`) USING BTREE,
  KEY `goods_tag` (`goods_tag`) USING BTREE,
  KEY `goods_name` (`goods_name`) USING BTREE,
  KEY `goods_en` (`goods_en`) USING BTREE,
  KEY `goods_hits_day` (`goods_hits_day`) USING BTREE,
  KEY `goods_hits_week` (`goods_hits_week`) USING BTREE,
  KEY `goods_hits_month` (`goods_hits_month`) USING BTREE,
  KEY `goods_time_add` (`goods_time_add`) USING BTREE,
  KEY `goods_time_make` (`goods_time_make`) USING BTREE,
  KEY `goods_lock` (`goods_lock`),
  KEY `goods_score` (`goods_score`),
  KEY `goods_score_all` (`goods_score_all`),
  KEY `goods_score_num` (`goods_score_num`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='商品表';

-- ----------------------------
-- Table structure for mac_goods_type
-- ----------------------------
DROP TABLE IF EXISTS `mac_goods_type`;
CREATE TABLE `mac_goods_type` (
  `type_id` smallint(6) unsigned NOT NULL AUTO_INCREMENT COMMENT '分类ID',
  `type_pid` smallint(6) unsigned NOT NULL DEFAULT '0' COMMENT '父级分类ID',
  `type_mid` smallint(6) unsigned NOT NULL DEFAULT '0' COMMENT '模块ID(预留)',
  `type_name` varchar(60) NOT NULL DEFAULT '' COMMENT '分类名称',
  `type_en` varchar(60) NOT NULL DEFAULT '' COMMENT '英文名',
  `type_sort` smallint(6) unsigned NOT NULL DEFAULT '0' COMMENT '排序值',
  `type_status` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '状态(1=正常,0=禁用)',
  ...
  `type_key` varchar(255) NOT NULL DEFAULT '' COMMENT 'SEO关键词',
  `type_des` varchar(255) NOT NULL DEFAULT '' COMMENT 'SEO描述',
  PRIMARY KEY (`type_id`),
...
-- ----------------------------
-- Table structure for mac_goods_order
-- ----------------------------
DROP TABLE IF EXISTS `mac_goods_order`;
CREATE TABLE `mac_goods_order` (
  `go_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '订单ID',
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
  `goods_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '商品ID',
  `go_status` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '订单状态(0=未支付,1=已支付,2=已关闭)',
  `go_code` varchar(30) NOT NULL DEFAULT '' COMMENT '订单编号',
  `go_price` decimal(12,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '订单金额',
  `go_points` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '积分金额',
  `go_num` int(10) unsigned NOT NULL DEFAULT '1' COMMENT '购买数量',
  `go_pay_type` varchar(10) NOT NULL DEFAULT '' COMMENT '支付方式',
  `go_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '下单时间',
  `go_pay_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '支付时间',
  `go_remark` varchar(255) NOT NULL DEFAULT '' COMMENT '备注',
  `go_goods_kind` tinyint(1) unsigned NOT NULL DEFAULT '1' COMMENT '1虚拟2实体',
  `go_ship_status` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '0待发货1已发货',
  `go_ship_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '发货时间',
  `go_express_name` varchar(64) NOT NULL DEFAULT '' COMMENT '快递公司',
  `go_express_no` varchar(128) NOT NULL DEFAULT '' COMMENT '运单号',
  `go_address_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '收货地址ID',
  `go_receiver_name` varchar(64) NOT NULL DEFAULT '' COMMENT '收货人',
  `go_receiver_phone` varchar(32) NOT NULL DEFAULT '' COMMENT '收货手机',
  `go_receiver_region` varchar(128) NOT NULL DEFAULT '' COMMENT '省市区',
  `go_receiver_address` varchar(512) NOT NULL DEFAULT '' COMMENT '详细地址',
  `go_download_snapshot` mediumtext COMMENT '虚拟商品发货内容快照',
  PRIMARY KEY (`go_id`),
  KEY `go_code` (`go_code`) USING BTREE,
  KEY `user_id` (`user_id`) USING BTREE,
  KEY `goods_id` (`goods_id`) USING BTREE,
  KEY `go_time` (`go_time`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='商品订单表';

-- ----------------------------
-- Table structure for mac_user_address
-- ----------------------------
DROP TABLE IF EXISTS `mac_user_address`;
CREATE TABLE `mac_user_address` (
...
-- 商品收藏与影视一致，使用 mac_ulog（ulog_mid=13, ulog_type=2），不单独建 mac_goods_favorite

-- ----------------------------
-- Table structure for mac_goods_paylog
-- ----------------------------
DROP TABLE IF EXISTS `mac_goods_paylog`;
CREATE TABLE `mac_goods_paylog` (
  `gp_id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '支付记录ID',
  `go_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '订单ID',
  `user_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '用户ID',
  `gp_amount` decimal(12,2) unsigned NOT NULL DEFAULT '0.00' COMMENT '支付金额',
  `gp_points` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '积分金额',
  `gp_channel` varchar(20) NOT NULL DEFAULT '' COMMENT '支付渠道',
  `gp_trade_no` varchar(64) NOT NULL DEFAULT '' COMMENT '第三方交易号',
  `gp_status` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '状态(0=未支付,1=支付成功,2=支付失败)',
  `gp_time` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '记录时间',
  `gp_ext` varchar(255) NOT NULL DEFAULT '' COMMENT '扩展信息',
  PRIMARY KEY (`gp_id`),
  KEY `go_id` (`go_id`) USING BTREE,
  KEY `user_id` (`user_id`) USING BTREE,
  KEY `gp_trade_no` (`gp_trade_no`) USING BTREE,
  KEY `gp_time` (`gp_time`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='商品支付记录表';
