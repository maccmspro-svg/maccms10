...
return [
    ...
    'install/title'=>'超级苹果CMS-V10系统安装',
    'install/header'=>'感谢您选择!',
    'install/header1'=>'MacCMS系统建站',
    'install/lang'=>'语言包',
    'install/select_lang'=>'请选择语言',
    'install/lang_tip'=>'请根据自己需要选择后台语言包',

    'install/user_agreement_title'=>'超级苹果CMS用户协议 适用于所有用户',
    'install/user_agreement'=>' 请您在使用(超级苹果CMS)前仔细阅读如下条款。包括免除或者限制作者责任的免责条款及对用户的权利限制。您的安装使用行为将视为对本《用户许可协议》的接受，并同意接受本《用户许可协议》各项条款的约束。 <br /><br />
                一、安装和使用： <br />
                (超级苹果CMS)是免费和开源提供给您使用的，您可安装无限制数量副本。 您必须保证在不进行非法活动，不违反所在国家相关政策法规的前提下使用本软件。 <br /><br />
                二、免责声明：  <br />
                ...
                三、协议规定的约束和限制：  <br />
                禁止去除(超级苹果CMS)源码里的版权信息，商业授权版本可去除后台界面及前台界面的相关版权信息。</br>
                禁止在(超级苹果CMS)整体或任何部分基础上发展任何派生版本、修改版本或第三方版本用于重新分发。</br></br>
                <strong>版权所有 (c) 2026，超级苹果CMS,保留所有权利</strong>。',
    ...
    'install/is_ok'=>'系统安装成功，欢迎您使用超级苹果CMS建站',
    'install/os'=>'操作系统',
    'install/php'=>'php版本',
    'install/gd'=>'GD库',
