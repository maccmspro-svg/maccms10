...
https://www.baidu.com/123.jpg',
  ...
  'admin/system/config/mainland_ip_limit' => 'Regional restrictions',
  'admin/system/config/mainland_ip_only_allow' => 'Only Allow',
  'admin/system/config/mainland_ip_not_allow' => 'Not Allow',
  'admin/system/config/mainland_ip_limit_tip'=>'Only allow: Only allow IP addresses from the mainland to access; not allow: do not allow IP addresses from the mainland to access;',
...
Note: If both black and white lists are filled, both policies will take effect.',
  ...
  'admin/vodplayer/play_mode' => 'Playback mode',
  'admin/vodplayer/play_mode_inner' => 'In-site player',
  'admin/vodplayer/play_mode_external' => 'Open external URL',
  'admin/vodplayer/external_btn_text' => 'External button label',
  'admin/vodplayer/external_btn_text_tip' => 'Red button text in external mode; leave blank to use site default (site_player.php external_btn_text) or fallback text',
  ...
  'install/user_agreement' => 'Before using Apple CMS, please carefully read the following terms. This includes disclaimers that exempt or limit the author\'s liability and restrictions on user rights. Your installation and use will be deemed acceptance of this "User License Agreement" and agreement to abide by all terms of this "User License Agreement". <br /><br />
                ...
                <strong>Copyright (c) 2026, Apple CMS. All rights reserved.</strong>',
