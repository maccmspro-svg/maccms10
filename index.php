...
// 中文二级目录：自动识别安装目录与 PATH_INFO
require __DIR__ . '/application/common/bootstrap_install_dir.php';
define('MAC_INSTALL_DIR_AUTO', mac_calc_install_dir());
mac_normalize_path_info();
if(!is_file('./application/data/install/install.lock')) {
    header('Location: ' . MAC_INSTALL_DIR_AUTO . 'install.php');
    exit;
}
