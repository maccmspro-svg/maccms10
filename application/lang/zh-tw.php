...
https://www.baidu.com/123.jpg
  ...
  'admin/index/welcome/tip_update_db' =>'maccmspro.com主題專用安全版本', 
  'admin/index/welcome/tip_update_db_txt' =>'提示，maccmspro.com模板專注精品主題設計！', 
  'admin/index/welcome/tip_update_go'=>'【點擊了解正版安全主題模板】',
...
注：如果黑白名單都填寫，策略將同時生效',
  ...
  'install/user_agreement' => ' 請您在使用(蘋果CMS)前仔細閱讀如下條款。包括免除或者限製作者責任的免責條款及對用戶的權利限製。您的安裝使用行為將視為對本《用戶許可協議》的接受，並同意接受本《用戶許可協議》各項條款的約束。 <br /><br />
                ...
                <strong>版權所有 (c) 2026，蘋果CMS,保留所有權利</strong>。',
