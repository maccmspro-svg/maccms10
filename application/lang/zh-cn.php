...
https://www.baidu.com/123.jpg
    ...
    'menu/goods' => '商品',
    'menu/goods_data' => '商品数据',
    'menu/goods_add' => '添加商品',
    'menu/goods_data_lock' => '未上架商品',
    'menu/goods_batch' => '批量操作商品',
    'menu/goods_order' => '商品订单',
    'menu/users'=>'用户',
    'menu/admin'=>'管理员',
    'menu/group'=>'会员组',
    'menu/user'=>'会员',
    ...
    'admin/public/head/title'=>'安全第一请勿泄露后台地址 - Copyright by 超级苹果CMS内容管理系统',
    'admin/public/jump/title'=>'跳转提示',

    'admin/index/login/title'=>'后台管理中心 - Copyright by 超级苹果CMS内容管理系统',
    ...
    'admin/index/welcome/tip_update_db' =>'maccmspro.com主题专用安全版本',
    'admin/index/welcome/tip_update_db_txt' =>'提示，maccmspro.com模板专注精品主题设计！',
    'admin/index/welcome/tip_update_go'=>'【点击了解正版安全主题模板】',
    ...
    'admin/vodplayer/play_mode'=>'播放模式',
    'admin/vodplayer/play_mode_inner'=>'站内播放',
    'admin/vodplayer/play_mode_external'=>'站外跳转播放',
    'admin/vodplayer/external_btn_text'=>'站外按钮文案',
    'admin/vodplayer/external_btn_text_tip'=>'站外模式时播放器区域红色按钮文字；留空则使用全站默认（application/extra/site_player.php 中 external_btn_text）或「前往站外播放」',
