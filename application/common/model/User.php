...
class User extends Base
{
    ...
    public function register($param)
    {
        ...
        if (!$is_from_3rdparty) {
            // https://github.com/maccmspro-svg/maccms10/issues/418
    ...
    public function login($param)
    {
        ...
        if (empty($data['openid'])) {
            ...
            // https://github.com/maccmspro-svg/maccms10/issues/781 兼容密码
    ...
    public function check_msg($param)
    {
        ...
        // https://github.com/maccmspro-svg/maccms10/issues/792 邮箱增加黑白名单校验
